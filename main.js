...
function firstQuestion(){
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire({
                title: 'hello nè<3😘 ',
                text: 'Chúc em có 1 ngày 20/10 vui vẻ 😊, một mùa 20/10 thật thú dị, may mắn, cố gắng đạt được nhiều thành thành tựu trong cuộc sống nhee🥰🥰🥰',
                imageUrl: 'baner.jpg',
                background: '#fff url("iput-bg.jpg")',
                imageAlt: 'Custom image',
                confirmButtonText: 'Cảm ơnn!😘'
              })
      .then((result) => {
        if (result.value) {
            var audio = new Audio('tick.mp3');
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.value) {
                                            ...
                                            Swal.fire({
                                                ...
                                                background: '#fff url("iput-bg.jpg")',
                                                title: 'Chúc em một ngày 20/10 vui vẻ không quạo nha🥰😘😘',
                                                text: 'NHÁAAA! Hhee🥰🥰🥰',
